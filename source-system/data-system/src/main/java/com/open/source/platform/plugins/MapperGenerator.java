...
public class MapperGenerator {
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath+"\\"+moduleName+"\\"+"src\\main\\java\\com\\open\\source\\platform");
...
//        });
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/open_source_platform?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT");
...
//    strategy.setTablePrefix(new String[] { "tlog_", "tsys_" });// 此处可以修改为您的表前缀
        ...
        strategy.setInclude(new String[]{scanner("需要生成的表")}); // 需要生成的表
...
//        pc.setParent(projectPath+"\\"+moduleName+"\\"+"src\\main\\java\\com\\open\\source\\platform");
